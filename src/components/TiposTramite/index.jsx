...
import { generatePDFTipoTramite } from "../../api/GenerarPDF.js";
import {generateExcelTipoTramite} from "../../api/GenerarExcel.js"

function TiposTramites({ tiposTramite }) {
  // Estado para el filtro de búsqueda
  const [searchTerm, setSearchTerm] = useState("");
  const navigate = useNavigate();

  // Filtrar los trámites según el término de búsqueda (nombre o código)
  const filteredItems = tiposTramite.filter(
    (tramite) =>
  ...
  return (
    <div className="w-2/3 flex flex-col ">
      ...
      <Pagination
        ...
        totalPages={Math.ceil(tiposTramite.length / itemsPerPage)}
